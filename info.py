...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002366465096 -1003353030088').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003871050459")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003297155836 -1002164939634 -1003353030088")# Channels for force sub (make sure bot is admin)
...
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/AddaFilez")   # Third tutorial link for verification
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Contact_AddaFileZ_bot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Adda_Botz') # Update channel link for the bot
